...
- [ ] T07 phonics-L07-vowel-teams *(authored via `scripts/gen-vowel-teams.mjs` + wired + lint-clean 2026-07-20, **72 decode + 72 encode items** + lessons; pending owner sign-off)*
