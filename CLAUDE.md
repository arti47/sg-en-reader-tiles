...
- [ ] T10 phonics-L10-two-syllable *(authored via `scripts/gen-two-syllable.mjs` + wired + lint-clean 2026-07-20, **65 decode + 65 encode items** + lessons; pending owner sign-off)*
