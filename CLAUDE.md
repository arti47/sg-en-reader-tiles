...
- [ ] T03 phonics-L03-digraphs (sh ch th ck) *(authored + wired + lint-clean 2026-07-20, **60 decode + 60 encode items** + lessons; pending owner sign-off)*
- [x] T04 phonics-L04-blends *(owner-approved 2026-07-20; 70 decode + 70 encode via `scripts/gen-blends.mjs`, lint-clean)*
- [ ] T05 phonics-L05-floss-doubling *(authored via `scripts/gen-floss.mjs` + wired + lint-clean 2026-07-20, **58 decode + 58 encode items** + lessons; pending owner sign-off)*
- [ ] T06 phonics-L06-silent-e *(authored via `scripts/gen-silent-e.mjs` + wired + lint-clean 2026-07-20, **64 decode + 64 encode items** + lessons; pending owner sign-off)*
