...
export function M3Demo() {
  ...
  if (import.meta.env.DEV) (window as unknown as { __m3?: unknown }).__m3 = { cloze, comp, dict, edit }
  return (
    <div className="stack">
      <h1>M3 demo</h1>
      ...
      <div data-testid="m3-edit"><McqItem item={edit} onAnswer={() => { /* feedback shown inline */ }} /></div>
    </div>
  )
}
