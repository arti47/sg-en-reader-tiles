...
- [ ] T08 phonics-L08-r-controlled *(authored via `scripts/gen-r-controlled.mjs` + wired + lint-clean 2026-07-20, **74 decode + 74 encode items** + lessons; pending owner sign-off)*
