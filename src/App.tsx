...
import { getSkill, SKILLS, pickItem, drillItemsFor } from './lib/packs'

if (import.meta.env.DEV) {
  const w = window as unknown as Record<string, unknown>
  w.__srs = srs; w.__engine = engine; w.__getSkill = getSkill
  w.__store = store; w.__readiness = readiness; w.__aggregate = aggregate; w.__scoring = scoring; w.__gamify = gamify; w.__support = support; w.__learn = learn; w.__sounds = sounds; w.__economy = economy; w.__diagnose = diagnoseLib; w.__adapt = adaptLib; w.__fatigue = fatigueLib; w.__packs = { pickItem, drillItemsFor }
