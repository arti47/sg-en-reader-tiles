...
- [ ] T09 phonics-L09-diphthongs *(authored via `scripts/gen-diphthongs.mjs` + wired + lint-clean 2026-07-20, **76 decode + 76 encode items** + lessons; pending owner sign-off)*
