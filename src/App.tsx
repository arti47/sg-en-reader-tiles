...
if (import.meta.env.DEV) {
  ...
  w.__store = store; w.__readiness = readiness; w.__aggregate = aggregate; w.__scoring = scoring; w.__gamify = gamify; w.__support = support; w.__learn = learn; w.__sounds = sounds; w.__economy = economy; w.__diagnose = diagnoseLib
